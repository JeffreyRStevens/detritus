...
#' Find a fixed proportion between the minimum and maximum values in a vector
#'
#' @description
#' This function finds the minimum and maximum values in a vector then
#' calculates a requested proportion of that. It is used to place text in
#' plots.
#'
#'
#' @param vec Numeric vector of data values
#' @param prop Numeric scalar of proportion to be calculated
#'
#' @return
#' Scalar value of calculated proportion
#' @export
#'
#' @examples
